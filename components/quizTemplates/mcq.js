                                ...
                                <div className='min-h-[400px]'>
                                    ...
                                    <ul className="list-none pl-5 space-y-4">
                                        {currentQuestion.options.map((option) => (
                                            <li key={option._id} className="my-2 flex items-start  gap-4">
                                                <input
                                                    type="radio"
                                                    name="option"
                                                    id={option._id}
                                                    ...
                                                    className="allow-clicks mt-[2px] min-h-[20px] min-w-[20px] border-none cursor-pointer bg-gray-300 appearance-none checked:bg-blue-500 rounded-full  focus:outline-none"
                                                />
                                                <label className='cursor-pointer allow-clicks break-all'
                                                    htmlFor={option._id}
